...
final class DecodeHandler extends Handler {
    ...
    DecodeHandler(CaptureActivityHandler handler,Context context) {
    ...
    private void decode(byte[] data, int width, int height) {
        ...
        PlanarYUVLuminanceSource source = CameraManager.getInstance(mContext).buildLuminanceSource(rotatedData, width, height);
        ...
        if (rawResult != null) {
            ...
            Message message = Message.obtain(captureActivityHandler, R.id.decode_succeeded, rawResult);
